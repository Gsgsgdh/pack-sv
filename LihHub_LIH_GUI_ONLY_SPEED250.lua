...
function TPB(v432)
    ...
    local v434 = TweenInfo.new((game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame.Position - v432.Position).Magnitude / 250, Enum.EasingStyle.Linear)
...
-- Lih hub GUI background controls.
-- Feature logic below this point is intentionally untouched.
...
-- ============================================================
-- LIH HUB GUI ONLY: BACKGROUND SETTINGS
-- ============================================================
pcall(function()
    ...
    v496:AddToggle({
        ...
        Callback = function(value)
            LihHubBackground.Enabled = value == true
            ApplyLihHubBackground()
        end
    })
...
function TweenToPosition(v566)
    ...
    if not v568 then
        ...
        local v570 = (v568.Position - v566.Position).Magnitude / 250
