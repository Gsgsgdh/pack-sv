...
local v466 = vu32:MakeWindow({
    ...
    SaveFolder = "Lih Hub | Blox Fruits"
})
...
-- ============================================================
-- LIH HUB RGB TITLE
-- Kept separate from the library layout so UI creation cannot be broken.
-- ============================================================
task.spawn(function()
    task.wait(1)
    pcall(function()
        ...
        local function update()
            for _, obj in ipairs(CoreGui:GetDescendants()) do
                if obj:IsA("TextLabel") and obj.Text == "Lih hub | Blox Fruits" then
                    obj.TextColor3 = Color3.fromHSV((os.clock() * 0.12) % 1, 0.9, 1)
                end
            end
        end
